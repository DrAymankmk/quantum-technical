...
<section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
	...
	<div class="container">
		...
		<div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
			<a href="{{ route('frontend.home.index') }}">{{ __('Home') }}</a><span>@include('frontend.template-1.components.directional-icon', ['icon' => 'angles-right', 'class' => 'mx-2']){{ __('IT Services') }}</span>
		</div>
	</div>
</section>
