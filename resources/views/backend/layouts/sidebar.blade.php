  ...
  <div class="leftside-menu">
  	...
  	<a class="logo text-center" href="#">
  		<span class="logo-lg">
  			<i class="fas fa-laptop-code"></i> <span class="logo-text">KAREEM SOFT</span>
  		</span>
  		<span class="logo-sm">
  	...
  	<div class="h-100" id="leftside-menu-container" data-simplebar="">
  		...
  		<ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarCmsPages" aria-expanded="false" aria-controls="sidebarCmsPages" class="side-nav-link">
